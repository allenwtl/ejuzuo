...
public class ExcelUtil {
     ...
     *                        should happen;
     *                          ExcelUtil.EXPAND_ROW
     *                          ExcelUtil.EXPAND_COLUMN
     *                          ExcelUtil.EXPAND_ROW_AND_COLUMN
     *                          ExcelUtil.OVERLAY_ROW_AND_COLUMN
    ...
    public void addImageToSheet(int colNumber, int rowNumber, Sheet sheet, Drawing drawing,
        ...
        if((resizeBehaviour != ExcelUtil.EXPAND_COLUMN) &&
                (resizeBehaviour != ExcelUtil.EXPAND_ROW) &&
                (resizeBehaviour != ExcelUtil.EXPAND_ROW_AND_COLUMN) &&
                (resizeBehaviour != ExcelUtil.OVERLAY_ROW_AND_COLUMN)) {
            throw new IllegalArgumentException("Invalid value passed to the " +
                    "resizeBehaviour parameter of ExcelUtil.addImageToSheet()");
        }
        ...
        if(colWidthMM < reqImageWidthMM) {
            ...
            if((resizeBehaviour == ExcelUtil.EXPAND_COLUMN) ||
                ...
                if(sheet instanceof HSSFSheet) {
                    ...
                    pictureWidthCoordinates = (int)reqImageWidthMM * ExcelUtil.EMU_PER_MM;
                }
            ...
            else if ((resizeBehaviour == ExcelUtil.OVERLAY_ROW_AND_COLUMN) ||
                    (resizeBehaviour == ExcelUtil.EXPAND_ROW)) {
    ...
    private ClientAnchorDetail fitImageToRows(Sheet sheet, int rowNumber,
        ...
        if(rowHeightMM < reqImageHeightMM) {
            if((resizeBehaviour == ExcelUtil.EXPAND_ROW) ||
                    (resizeBehaviour == ExcelUtil.EXPAND_ROW_AND_COLUMN)) {
            ...
            // the image out ver one or more rows.
                    ...
                    (resizeBehaviour == ExcelUtil.EXPAND_COLUMN)) {
    ...
    private ClientAnchorDetail calculateColumnLocation(Sheet sheet,
        ...
        if((int)totalWidthMM == (int)reqImageWidthMM) {
            ...
            if(sheet instanceof HSSFSheet) {
                ...
                anchorDetail = new ClientAnchorDetail(startingColumn,
                        toColumn, (int)reqImageWidthMM * ExcelUtil.EMU_PER_MM);
            }
        }
        ...
        // for the ClientAnchorDetail object.
            ...
            if(sheet instanceof HSSFSheet) {
                ...
                inset = (int)overlapMM * ExcelUtil.EMU_PER_MM;
            }
    ...
    private ClientAnchorDetail calculateRowLocation(Sheet sheet,
        ...
        if((int)totalRowHeightMM == (int)reqImageHeightMM) {
            if(sheet instanceof HSSFSheet) {
                ...
                clientAnchorDetail = new ClientAnchorDetail(startingRow, toRow,
                        (int)reqImageHeightMM * ExcelUtil.EMU_PER_MM);
            }
        }
        else {
     ...
     *
     *      ExcelUtil addImage = new ExcelUtil();
     *
     ...
     *          ExcelUtil.EXPAND.ROW);
     *
     * @param args the command line arguments
     */
    public static void main(String[] args) throws IOException {
        //String imageFile = "C:\\Users\\tianlun.wu\\Desktop\\图片\\床2.png";
        //String imageFile = "http://r.ejuzuo.com/img/digital_furniture/2017/01/04/20170104145235061-5235123.jpg";
        String outputFile = "D:\\a.xlsx";
        FileOutputStream fos = null;
        Workbook workbook = null;
        Sheet sheet = null;

//        if(args.length < 2){
//            System.err.println("Usage: ExcelUtil imageFile outputFile");
//            return;
//        }
...
//        imageFile = args[0];
//        outputFile = args[1];
        URL url = new URL("http", "r.ejuzuo.com",80,"/img/digital_furniture/2016/05/21/20160521163500046-small.jpg");
        new ExcelUtil().addImageToSheet("B5", sheet, sheet.createDrawingPatriarch(),
                url, 20, 20,
                ExcelUtil.OVERLAY_ROW_AND_COLUMN);
    ...
    public static void addImageToExcel(Sheet sheet,String filePath, String cellNumber) throws IOException {
        URL url = new URL("http", "r.ejuzuo.com",80, filePath);
        new ExcelUtil().addImageToSheet(cellNumber, sheet, sheet.createDrawingPatriarch(),
                url, 20, 20,
                ExcelUtil.OVERLAY_ROW_AND_COLUMN);
    }
