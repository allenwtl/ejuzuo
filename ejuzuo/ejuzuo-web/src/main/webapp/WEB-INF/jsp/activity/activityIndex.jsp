...
<head>
  ...
  <link rel="stylesheet" href="${resUrl}/styles/common.css?v=20160728000">
  ...
  <li class="appendTo">
    <div class="new_activity_box">
      <a href="/activity/detail/{{=value.id}}" target="_blank">
        <div class="pic_box">
          <img src="${resUrl}/{{=value.thumbnail}}" class="blockImg" alt="">
...
<script type="text/javascript" src="${resUrl}/js/activity/activityInfo.js"></script>
</body>
</html>