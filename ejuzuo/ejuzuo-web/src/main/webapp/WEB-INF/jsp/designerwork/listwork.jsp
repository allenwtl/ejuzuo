...
<script type="text/template" id="dotTemplate">
    ...
    {{??}}
        ...
        <li class="appendTo">
            <div class="imgbox">
                <a href="/designerWork/detail/{{=value.id}}"><img src="${resUrl}{{=value.coverImg}}" class="blockImg" alt=""></a>
            </div>
            <div class="user_box clearfix">
                <div class="userpic_box">
                    <i class="user_icon"></i>
                    <a href="/designer/detail/{{=value.memberId}}"><img src="${resUrl}{{=value.designerImg}}" alt=""></a>
                </div>
                <div class="user_txt">
...
<script type="text/javascript" src="${resUrl}/plugin/doT/1.0.1/doT.min.js"></script>
<script type="text/javascript" src="${resUrl}/js/designerwork/designerwork.js"></script>
</body>
</html>