        ...
        <tr class="appendTo">
          ...
          <td>
            <div class="case_msg clearfix">
              <div class="left_imgbox"><a href="/digital/digitalDetail/{{=value.digitalFurniture.id}}" ><img src="${resUrl}{{=value.digitalFurniture.thumbnail}}" alt=""></a></div>
...
<script type="text/javascript" src="${resUrl}/js/buycar/buycar.js"></script>
