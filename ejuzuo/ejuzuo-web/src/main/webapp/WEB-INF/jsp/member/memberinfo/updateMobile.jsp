              ...
              <div class="safe_center">
                <div class="tabWrap">
                  <div class="tabBtnBox clearfix">
                    ...
                    <a href="/member/toUpdateME/mobile" class="tabBtn on">手机号码修改</a>
                        ...
                        <div class="safe_form_wrap" style="margin-left:0; margin-top:40px;">
                          ...
                          <div class="ele_wrap">
                            <div class="input_block mandatory mb20">
                              ...
                              <input type="text" class="w350" name="oldStr" placeholder="请输入旧手机" required>
                            </div>
                            <div class="input_block mandatory mb20">
                              <span class="star">*</span>
                              <input type="text" id="newStr" name="newStr" class="w230" placeholder="请输入新手机号码" required>
                              <a href="javascript:void(0);" class="btn" id="sendCode" style="width: 70px;" data="mobile">发送验证码</a>
                            </div>
                            <div class="input_block mandatory mb20">
                              <span class="star">*</span>
                              <input type="text" class="w350" placeholder="请输入验证码" name="code" required>
                            </div>
                            <div class="btn_block">
...
<script type="text/javascript" src="${resUrl}/js/member/updateMemberInfo.js"></script>
</body>
</html>