    ...
    <div class="">
      ...
      <div class="common_block mt20">
        <div class="designer_intro_box clearfix">
          <div class="left_picbox"><img src="${resUrl}${el:toJSONObject(data.coverImg).pic500500}" class="blockImg" alt=""></div>
  ...
  {{??}}
    ...
    <li class="appendTo">
      <a href="/designerWork/detail/{{=value.id}}" class="case_block" target="_blank">
        <img src="${resUrl}{{=value.coverImg}}" alt="">
...
<script type="text/javascript" src="${resUrl}/plugin/doT/1.0.1/doT.min.js"></script>
<script type="text/javascript" src="${resUrl}/js/designer/designerDetail.js"></script>
