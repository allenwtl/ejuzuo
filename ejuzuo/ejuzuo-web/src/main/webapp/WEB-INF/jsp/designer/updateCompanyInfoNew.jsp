    ...
    <div class="main">
        <div class="clearfix">
            ...
            <div class="right_box" id="partRight">
                <div class="sections">
                    <div class="title_box">
                        <span class="txt">我是设计师-${data.designerType== 2 ? "装修公司":"设计公司"}</span>
                    </div>
                    <div class="midcont_box">
                        <form action="/designer/update" method="post" id="updateCompany">
                            <div class="contheight_box whitebg">
                                <div class="authentication_box">
                                    ...
                                    <div class="clearfix">
                                        <div class="left_box">
                                            <div class="ele_wrap">
                                                <div class="input_block mandatory mb20">
                                                    ...
                                                    <input type="text" class="w340" placeholder="公司名称" name="name" value="${data.name}"
                                            ...
                                            <div class="ele_wrap">
                                                <div class="input_block mandatory mb20">
                                                    <span class="star">*</span>
                                                    <input type="text" class="w340" placeholder="联系人" name="contact" value="${data.contact}"
                                                           required <c:if test="${data.status == 1 || data.status == 2}">disabled</c:if> >
                                                </div>
                                            </div>
                                            ...
                                            <div class="ele_wrap clearfix">
                                                <div class="input_block select_box mb20 ">
                                                    <span class="star">*</span>
                                                    <input type="text" class="w70" <c:if test="${data.status == 1 || data.status == 2}">disabled</c:if> placeholder="公司规模">
                                                    <div class="guimo_sl_list sl_box">
                                        ...
                                        <div class="right_box">
                                            <div class="ele_wrap">
                                                <div class="input_block mandatory mb20">
                                                    <span class="star">*</span>
                                                    <input type="text" class="w340" placeholder="公司法人" name="corporation" value="${data.corporation}"
                                                           required <c:if test="${data.status == 1 || data.status == 2}">disabled</c:if> >
                                                </div>
                                            </div>
                                            <div class="ele_wrap">
                                                <div class="input_block mandatory mb20">
                                                    <span class="star">*</span>
                                                    <input type="text" class="w340" placeholder="联系人手机号码" name="contactMobile" value="${data.contactMobile}"
                                                           required <c:if test="${data.status == 1 || data.status == 2}">disabled</c:if> >
                                                </div>
                                            </div>
                                            <div class="ele_wrap">
                                                <div class="input_block mb20">
                                                    <span class="star">*</span>
                                                    <input type="text" class="w350" placeholder="请填写详细地址" name="address" value="${data.address}"
                                                           required <c:if test="${data.status == 1 || data.status == 2}">disabled</c:if> >
                                                </div>
                                            </div>
                                            <div class="ele_wrap">
                                                <div class="input_block mandatory mb20">
                                                    <span class="star">*</span>
                                                    <input type="text" class="w340" placeholder="注册资金" name="regFund" value="${data.regFund}" required
                                                           <c:if test="${data.status == 1 || data.status == 2}">disabled</c:if> >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="right_box">
                                            ...
                                            <div class="label_wrap">
                                                ...
                                                <div class="upload_picshowbox">
                                                	<img src="/designer/queryLicenseImg?path=${data.licenseImg }">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="right_box">
                                            ...
                                            <div class="label_wrap">
                                                ...
                                                <div class="upload_picshowbox">
                                                    <img src="${resUrl}${el:toJSONObject(data.coverImg).picold}" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="youckbox">
                                        ...
                                        <div class="checked_box pt15 clearfix">
                                            ...
                                            <div class="label_wrap" id="fengge">
                                                <c:forEach items="${fengge}" var="item">
                                                    <label for="" data="${item.valueCode}"><i></i>${item.valueName}
                                                    </label>
                                                </c:forEach>
                                            </div>
                                        </div>
                                        ...
                                        <div class="pt15 clearfix">
                                            ...
                                            <div class="label_wrap">
                                                <textarea name="experience"><c:out value="${data.experience}" /></textarea>
                                            </div>
                                        </div>
                                ...
                                <input name="companySize" type="hidden" id="companySizeHidden" value="${data.companySize}"/>
                                <input name="licenseImg" type="hidden" id="licenseImgHidden" value='${data.licenseImg}'/>
                                <input name="adeptStyles" id="adeptStylesHidden" type="hidden" value="${data.adeptStyles}"/>
                                <input name="designerType" type="hidden" value="${data.designerType}" id="designerTypeHidden"/>
                                ...
                                <div class="authentication_btn_box clearfix">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <a href="/designer/toworks/1" class="btn fl" style="width:200px; margin-left:110px">添加作品</a>
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                            </div>
...
<script type="text/javascript" src="${resUrl}/js/designer/updateCompany.js?v=1"></script>
