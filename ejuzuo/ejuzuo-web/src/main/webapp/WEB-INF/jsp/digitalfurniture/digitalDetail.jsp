            ...
            <div class="fl">
              <div class="produce_detail">
                    ...
                    <%--<ul class="simallpic_list clearfix" id="imgselect"  >--%>
                      <c:forEach items="${el:getJSONArray(data.pictures)}" var="pic">
                        <li  class="swiper-slide">
                          <img src="${resUrl}${pic.img205100}" class="blockImg" alt="" title="${pic.intro}" data="${resUrl}${pic.img850478}">
                ...
                <div class="produce_intro_table mt10">
                  <table width="100%">
                    <tr class="greybg">
                      <td width="30%"><div class="pl20">单件名称</div></td>
                      <td width="30%"><div class="pl20">产品尺寸</div></td>
                      <td width="20%"><div class="pl20">材质</div></td>
                      <td width="10%"><div class="pl20">价格（元）</div></td>
                    </tr> 
        ...
        <div class="pl10 pr10 pt20">
          <ul class="produce_list produce_280 clearfix">
            <c:forEach items="${matchGood}" var="item">
              <li>
                <a href="/digital/digitalDetail/${item.id}"><img src="${resUrl}${item.thumbnail}" alt=""></a>
                ...
                <div class="user_imgbox">
                  <c:choose>
                    <c:when test="${requestScope.memberInCache.designer}">
                      <i class="user_icon"></i>
                      <a href="/designer/detail/${requestScope.memberInCache.designerId}"><img src="${resUrl}${el:toJSONObject(requestScope.memberInCache.profileImg).pic4343}" alt=""></a>
                    </c:when>
                    <c:otherwise>
                      <a href="javascript:void(0)">
                        <img src="${resUrl}${el:toJSONObject(requestScope.memberInCache.profileImg).pic4343}" alt="">
                      </a>
                    </c:otherwise>
                  </c:choose>
                </div>
      ...
      <li class="appendTo">
        <div class="user_pic_box">
          <i class="{{? value.designer }}user_icon{{?}} user_icon1"></i>
            <img src="${resUrl}{{=value.profileImg}}" alt="">
        </div>
...
<script type="text/javascript" src="${resUrl}/js/digitalfurniture/digitalDetail.js"></script>
