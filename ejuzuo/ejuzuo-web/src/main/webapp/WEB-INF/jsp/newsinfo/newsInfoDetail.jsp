      ...
      <div class="common_block">
        <div class="detail_wrap">
          ...
          <div class="clearfix">
            ...
            <div class="right_box">
              <div class="related_recom pt20 txtlink">
                <div class="title_box">
                  <a href="/newsInfo/index" class="more" target="_blank">更多</a>
                  <span class="titletxt">相关推荐</span>
                </div>
                <div class="pr10 pt10">
                  <ul class="produce_list produce_280 clearfix">
                    <c:forEach var="item" items="${newsInfoList}">
                      <li>
                        <a href="/newsInfo/detail/${item.id}" class="ellipTxt">${item.title}</a>
                      </li>
                    </c:forEach>
                  </ul>
                </div>
