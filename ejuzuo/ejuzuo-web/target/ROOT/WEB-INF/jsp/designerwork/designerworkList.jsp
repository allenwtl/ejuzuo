...
<%--    <td>
    ...
    <td>
      <div class="case_msg clearfix">
        <div class="left_imgbox"><a href="/designerWork/detail/{{=value.id}}" target="_blank"><img src="http://r.ejuzuo.com{{=value.coverImg}}" alt="" style="margin-left: 10px;"></a></div>
...
<script type="text/javascript" src="http://r.ejuzuo.com/js/designerwork/designerworkList.js"></script>
