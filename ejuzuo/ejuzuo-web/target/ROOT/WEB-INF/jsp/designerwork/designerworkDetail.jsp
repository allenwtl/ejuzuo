              ...
              <div class="cont_introbox">
                <div>
                  <c:forEach items="${el:getJSONArray(data.content)}" var="item">
                    <img src="http://r.ejuzuo.com${item.img}" alt="">
                    <p>${item.intro}</p>
                  </c:forEach>
                </div>
            ...
            <div class="right_box">
              <div class="desiner_box">
                <div class="clearfix">
                  <div class="imgbox">
                    <i class="user_icon"></i>
                    <a href="/designer/detailByMemberId/${data.memberId}"><img src="http://r.ejuzuo.com${data.designerImg}" alt=""></a>
                  </div>
                  <div class="txtbox">
...
<script type="text/javascript" src="http://r.ejuzuo.com/js/designerwork/designerworkDetail.js"></script>
