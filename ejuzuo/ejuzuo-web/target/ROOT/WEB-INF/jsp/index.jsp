...
<head>
    ...
    <link rel="stylesheet" href="http://r.ejuzuo.com/styles/common.css?v=20160808000">
    ...
    <div class="main pt20">
        ...
        <div>
            ...
            <div class="common_block mt20 ">
                <div class="title_box">
                    <a href="/digital/index" class="more" target="_blank">更多</a>
                            ...
                            <c:if test="${status.index <=3}">
                                <li>
                                    <a href="/designer/detail/${item.id}">
                                        <img src="http://r.ejuzuo.com${el:toJSONObject(item.coverImg).pic280280}" alt="">
...
<!--                     <div class="ds_reco produce_list js_ds_cpn_reco">
                    ...
                    <ul class="produce_list produce_280 clearfix">
                        <c:forEach items="${personList}" var="item" varStatus="status">
                            <c:if test="${status.index <=3}">
                                <li>
                                    <a href="/designer/detail/${item.id}">
                                        <img src="http://r.ejuzuo.com${el:toJSONObject(item.coverImg).pic280280}" alt="" style="height: 280px;">
                                        <div class="gradient_txtbox">
                                            <span class="left_txt">${item.name}</span>
                                            <span class="right_txt">
                                                <c:choose>
            ...
            <%--<div class="ad1 mt20"><a href="#" target="_blank"><img src="http://r.ejuzuo.com/images/img/ad2.jpg" class="blockImg" alt=""></a></div>--%>
                            ...
                            <%--<li>--%>
                                <%--<div class="new_activity_box">--%>
                                    <%--<a href="/activity/detail/${item.id}" target="_blank">--%>
                                        <%--<div class="pic_box">--%>
                                            <%--<img src="http://r.ejuzuo.com${item.thumbnail}" class="blockImg" alt="">--%>
                                            <%--<div class="gradient_txtbox">--%>
                        ...
                        <c:forEach items="${news}" var="item">
                            <li>
                                <div class="news_box clearfix">
                                    <a href="/newsInfo/detail/${item.id}" class="left_imgbox"><img src="http://r.ejuzuo.com${item.thumbnail}" alt=""></a>
            ...
            <div class="common_block mt20 mb20">
                ...
                <ul class="brand_list clearfix">
                    <c:forEach items="${brand}" var="item">
                        <li><a href="/digital/digitalList/0/0/0/${item.id}" class="brand_box"><img src="http://r.ejuzuo.com${item.logoImg}" alt=""></a></li>
                    </c:forEach>
                </ul>
            </div>
        </div>
...
<script type="text/javascript" src="http://r.ejuzuo.com/plugin/jquery-marquee/jquery.marquee.js"></script>
...
<script type="text/javascript" src="http://r.ejuzuo.com/js/index/index.js"></script>
