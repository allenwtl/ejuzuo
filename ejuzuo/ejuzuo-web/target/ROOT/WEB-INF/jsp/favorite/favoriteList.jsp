  ...
  {{??}}
    ...
    <li class="appendTo">
      <div class="edit_ablock bindCheckedAll checked_box favoriteDelete" >
        ...
        <img src="http://r.ejuzuo.com{{=value.coverImg}}" alt="" style="width: 315px; height: 315px;">
...
<script type="text/javascript" src="http://r.ejuzuo.com/js/favorite/favorite.js"></script>
</body>
</html>