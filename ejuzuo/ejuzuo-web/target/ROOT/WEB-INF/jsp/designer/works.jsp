  ...
  <div class="main">
    <div class="clearfix">
      ...
      <div class="right_box" id="partRight">
        <div class="sections">
          <div class="title_box">
            <span class="txt">作品管理-${type == 3 ? "高级用户设计师认证":"高级用户公司认证"}</span>
          </div>
          <div class="midcont_box">
            <form id="worksForm" action="/designer/savework" method="post">
            <div class="contheight_box whitebg">
              ...
              <input type="hidden" id="business" value="apply"/>
              <input name="style" id="adeptStylesHidden" type="hidden" />
              <div class="authentication_btn_box" style="padding-left: 300px;">
...
<script type="text/javascript" src="http://r.ejuzuo.com/js/designer/designerWorks.js"></script>
</body>
</html>
