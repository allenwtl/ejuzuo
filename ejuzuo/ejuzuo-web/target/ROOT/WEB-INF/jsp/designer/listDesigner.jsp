...
<script type="text/template" id="dotTemplate">
  ...
  <li class="appendTo">
    <div class="imgbox">
      <a href="/designer/detail/{{=value.id}}"><img src="http://r.ejuzuo.com{{=value.pic280280}}" class="blockImg" alt="" style="width: 285px; height: 285px;"></a>
    </div>
    <div class="user_box clearfix">
      <div class="userpic_box">
        <i class="user_icon"></i>
        <a href="/designer/detail/{{=value.id}}"><img src="http://r.ejuzuo.com{{=value.pic4343}}" alt=""></a>
      </div>
      <div class="user_txt">
        <p class="txt1">
...
<script type="text/javascript" src="http://r.ejuzuo.com/js/designer/listDesigner.js"></script>
</body>
</html>