...
<script type="text/template" id="dotTemplate">
  ...
  <li class="appendTo">
    <div class="news_box clearfix">
      <a href="/newsInfo/detail/{{=value.id}}" class="left_imgbox"><img src="http://r.ejuzuo.com/{{=value.thumbnail}}" alt=""></a>
...
<script type="text/javascript" src="http://r.ejuzuo.com/js/newsinfo/newsInfoList.js"></script>
