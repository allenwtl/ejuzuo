  ...
  <div class="main">
    <ul class="nav_list clearfix">
      <li class="navLi alltypeLi pull_list">
        ...
        <ul class="all_type_list" id="typeList">
      ...
      <li class="navLi"><a href="/digital/index/4" class="navBlock">品牌馆</a></li>
      <li class="navLi"><a href="/digital/index/2" class="navBlock">定制馆</a></li>
      <li class="navLi"><a href="/digital/index/3" class="navBlock">进口馆</a></li>
      <li class="navLi pull_list js_pull_list">
        <a href="/designer/queryDesigner/3/0/0" class="navBlock">设计师</a>
        <ul class="nav_pull_list">
          <li><a href="/designer/queryDesigner/3/0/0" target="">个人设计师</a></li>
          <li><a href="/designer/queryDesigner/2/0/0" target="">装修公司</a></li>
          <li><a href="/designer/queryDesigner/1/0/0" target="">设计公司</a></li>
        </ul>
      </li>
      <li class="navLi"><a href="/digital/index/1" class="navBlock">家居尾品汇</a></li>
...
<script type="text/template" id="dotTemplate_menu">
  <li class="alltype_aLi" style="height:56px">
    <i class="all_type_icon {{=it.bz || 'all_type_icon_kt'}}"></i>
    <div class="txtbox">
      <p class="typeName"><a href="/digital/digitalList/{{=it.valueCode}}/0/0/0/0">{{=it.valueName}}</a></p>
      <p>
        {{~it.subList :value:index}}
        {{? index<3}}
        <a href="/digital/digitalList/{{=it.valueCode}}/{{=value.valueCode}}/0/0/0">{{=value.valueName}}</a>
        {{?}}
        {{~}}
      </p>
    </div>
    <div class="service_float">
      <div class="service_float_item">
        <div class="service_fi_links">
          <div class="title_box"><a href="/digital/digitalList/{{=it.valueCode}}/0/0/0/0" class="more_link fr">{{=it.valueName}} {{=it.totalCount}}件商品》</a><span class="title_link">{{=it.valueName}}》</span></div>
          <ul class="tablink_list clearfix">
            {{~it.subList :value:index}}
            <li><a href="/digital/digitalList/{{=it.valueCode}}/{{=value.valueCode}}/0/0/0">{{=value.valueName}}</a></li>
            {{~}}
          </ul>
            <div class="type_r_img_box clearfix">
              ...
              <div class="type_r_img type_r_img_left" >
                ...
                <div class="type_r_img " >
                  {{?}}
                  <a href="/digital/digitalList/{{=it.valueCode}}/0/0/{{=value.id}}/0"><img src="http://r.ejuzuo.com{{=value.img}}" alt=""></a>
                </div>
                {{~}}
              </div>
            </div>
  ...
  $(document).ready(function () {
    ...
    $.getJSON('/index/navigation', function(data){
      for(var i=0; i<data.length; i++) {
        var tmpl = document.getElementById('dotTemplate_menu').innerHTML;
