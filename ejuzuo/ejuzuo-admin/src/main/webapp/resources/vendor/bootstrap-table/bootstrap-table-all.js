...
!function ($) {
	...
	var thisSortName = $this.data('sortName');
	if (!!thisSortName) {
	    if (this.options.sortName === thisSortName) {
        	this.options.sortOrder = this.options.sortOrder === 'asc' ? 'desc' : 'asc';
            } else {
        	this.options.sortName = thisSortName;
    ...
    BootstrapTable.prototype.getCaretHtml = function () {
        ...
        $.each(this.$header.find('th'), function (i, th) {
            if ($(th).data('sortName') === that.options.sortName || $(th).data('field') === that.options.sortName) {
