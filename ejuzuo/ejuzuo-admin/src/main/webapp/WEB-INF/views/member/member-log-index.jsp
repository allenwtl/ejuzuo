...
<c:set var="nav_second" value="member-log" scope="request"/>

<!DOCTYPE html>
<html>
<head>
<title>用户操作日志 - 用户管理</title>
</head>
<body>
	<ol class="breadcrumb">
	...
	<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<form id="page-toolbar" class="form-inline" role="form" autocomplete="off" style="line-height:34px;">
			...
			<div class="form-group form-group-sm">
				...
				<select class="form-control" id="filter-operType">
...
<footer-scripts>
<script type="text/javascript" src="/resources/scripts/member/member-log-index.js"></script>
</footer-scripts>
</html>