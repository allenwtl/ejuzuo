...
<c:set var="nav_second" value="member-care" scope="request"/>
...
<footer-scripts>
<script type="text/javascript" src="/resources/scripts/member/member-care-index.js"></script>
</footer-scripts>
</html>