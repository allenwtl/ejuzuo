...
<c:set var="nav_second" value="member-point-log" scope="request"/>
...
<body>
	...
	<div class="col-sm-12 col-md-12 col-lg-12">
		...
		<form id="page-toolbar" class="form-inline" role="form" autocomplete="off" style="line-height:34px;">
			...
			<div class="form-group form-group-sm">
				<label class="sr-only" for="filter-transType">事务类型</label>
				<select class="form-control" id="filter-transType">
					<option value="" selected="selected">--事务类型--</option>
					<c:forEach items="${transTypes }" var="transType">
						<option value="${transType.index }" ><c:out value="${transType.description }"/></option>
					</c:forEach>
				</select>
			</div>
			<div class="form-group form-group-sm">
...
<footer-scripts>
<script type="text/javascript" src="/resources/scripts/member/member-point-log-index.js"></script>
</footer-scripts>
</html>