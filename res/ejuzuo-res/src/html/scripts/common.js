...
document.write("<script src='scripts\/webdialog.js'><\/script>"); //添加弹窗组件js
	...
	content: "<div class='mydialog_cont mydialog_reg'>"+
				"<div>"+
					...
					"<div class='regway_box clearfix'>"+
						"<a href='#'><i class='qq_102_icon'></i><span>QQ 账号注册</span></a>"+
						"<a href='#'><i class='wx_102_icon'></i><span>微信账号注册</span></a>"+
						"<a href='#'><i class='zc_102_icon'></i><span>注册</span></a>"+
					"</div>"+
					"<div class='xieyibox checked_box'>"+
						"<label class='checked' for=''><i></i>我已阅读并接受 <a href='#''>版权声明</a> 和 <a href='#'>隐私保护</a> 条款</label>"+
					"</div>"+
				"</div>"+
			"</div>"
};
					...
					"<div class='login_form_wrap'>"+
						"<div class='ele_wrap'>"+
							"<div class='input_block mb20'>"+
								...
								"<input type='text' class='w350' placeholder='用户名|邮箱｜手机'>"+
							"</div>"+
							"<div class='input_block mb20'>"+
								"<span class='star'>*</span>"+
								"<input type='password' class='w350' placeholder='密码'>"+
							"</div>"+
							"<div class='btn_block'>"+
								"<a href='#'' class='block_btn btn'>登&nbsp;&nbsp;&nbsp;&nbsp;录</a>"+
							"</div>"+
							"<p class='logineretxt'>账号或者密码错误!</p>"+
						"</div>"+
						"<div class='loginLink'><a href='#'>忘记密码</a>|<a href='#'>免费注册</a></div>"+
